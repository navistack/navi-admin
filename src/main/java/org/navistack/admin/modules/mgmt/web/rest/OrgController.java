...
public class OrgController {
    ...
    @Tag(name = "Organization Management")
    public RestResult<Page<OrgDto>, ?> paginate(OrgQueryParams queryParams, PageRequest pageRequest) {
    ...
    @Tag(name = "Organization Management")
    public RestResult<Void, ?> create(@Validated({Default.class, Create.class}) OrgDto dto) {
        service.create(dto);
    ...
    @Tag(name = "Organization Management")
    public RestResult<Void, ?> modify(@Validated({Default.class, Modify.class}) OrgDto dto) {
        service.modify(dto);
        return RestResult.ok();
    }
